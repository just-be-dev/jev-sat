...
1 ---------~ Though not closely related, the hedgehog tenrecs of Madagascar share basic _______ true hedgehogs, including protective spines, pointed snouts, and small body size—traits the two groups of mammals independently developed in response to equivalent roles in their respective habitats.
...
_______ the long-standing trend of overemphasizing While recent scholarship has undermined claims that teenagers and young adults in research on social the works of twelfth-century Islamic philosopher Ibn media use, scholars have recently begun to expand Rushd were _______ other Muslim philosophers of their focus to include the fastest-growing cohort of his time, it is indisputable that his location in the social media users: senior citizens. Muslim-ruled area of what is now Spain meant that his works were primarily available thousands of miles Which choice completes the text with the most west of the era’s center of Islamic thought. logical and precise word or phrase? Which choice completes the text with the most
...
On painter William H. Johnson’s return to the United States in 1938 after a decade in Europe, his style underwent an abrupt transformation. <u>Turning</u> <u>away from landscapes painted in an expressionist</u> <u>style—a style that often involves using fluid, distorted</u> <u>shapes and thick, textured brushstrokes to express</u> <u>the artist’s subjective experience of reality—Johnson</u> <u>began painting portraits of Black Americans in a</u> <u>bold new way.</u> Evocative of African sculpture and American and Scandinavian folk art, these portraits feature flat, deliberately oversimplified figures in a vibrant but limited color palette.
...
Annual Car Production in the United States, 1910–1925 Number Number of of cars companies <u>Year produced producing cars</u> 1910 123,990 320 1915 548,139 224 1920 1,651,625 197 1925 3,185,881 80
...
Mean Attentiveness Scores by Leave Time Condition 600 540 480 420 360 300 240 180 120 60 0 Mean test score (higher scoresindicate greater attentiveness)first second third
...
It may seem that the optimal strategy for an animal pursuing prey or escaping predators is to move at maximal speed, but the energy expense of exploiting full speed capacity can disfavor such a strategy even in escape contexts, as evidenced by the fact that _______
...
Before it unveiled a massive new gallery in 2009, the The Inca of South America used intricately knotted Art Institute of Chicago was only able to display string devices called quipus to record countable about 5% of its art collection. _______ the museum information, like population data and payments. is able to display close to 30% of its collection. _______ they may have used quipus to record more complex information, like stories and myths, Which choice completes the text with the most according to researchers. logical transition? Which choice completes the text with the most
...
- She succeeded in creating sugarcane hybrids well suited to India’s climate. The student wants to emphasize Janaki Ammal’s achievement. Which choice most effectively uses relevant information from the notes to accomplish this goal?
...
- This pose symbolizes their support for each other in the pursuit of equality. The student wants to emphasize a similarity between the two sculptures. Which choice most effectively uses relevant information from the notes to accomplish this goal?
...
1 - The works of Chicana artist Ester Hernandez are now _______ in museums both in the United States and abroad, but the murals she contributed to as a member of Las Mujeres Muralistas early in her artistic career were displayed in outdoor public spaces across San Francisco.
...
Mean Ratings for Patients after 21 Days Mean rating for participants Mean rating for participants

|Measure|aware of taking a placebo|in the control group|
|---|---|---|
...
- These soldiers were known as the Navajo Code Talkers. The student wants to emphasize a similarity between the Choctaw Code Talkers and the Navajo Code Talkers. Which choice most effectively uses relevant information from the notes to accomplish this goal?
...
- There have been over 60,000 recorded meteorite finds. The student wants to contrast the number of meteorite falls with the number of meteorite finds. Which choice most effectively uses relevant information from the notes to accomplish this goal?
...
- *Polytrichum juniperinum* and *Sphagnum* *gracilescen* are both species of moss. The student wants to emphasize the sample collected from Serra de Itatiaia. Which choice most effectively uses relevant information from the notes to accomplish this goal?
...
- Diplomatic correspondence includes communication with both allies and adversaries. The student wants to indicate which category most routine diplomatic correspondence belongs in, based on how sensitive information is classified. Which choice most effectively uses relevant information from the notes to accomplish this goal?
...
- The domain of a given function f *f(x)* is a real number.
#### REFERENCE

#### @ 4£

1 *V* = i,.r3 *V=½nr²h V =3£wh* 3

The number of radians of arc in a circle is *2n.* The sum of the measures in degrees of the angles of a triangle is 180.
...
How many <u>yards</u> are equivalent to 1,116 inches?
...
*f* (*x*) = 14 + 4*xt* *P t*( ) = 1,800 1.02 () The function *f* represents the total cost, in dollars, of The function *P* gives the estimated number of attending an arcade when *x* games are played. How marine mammals in a certain area, where *t* is the many games can be played for a total cost of $58? number of years since a study began. What is the best interpretation of *P*(0) = 1,800 in this context?
...
8 the area increased by 102 each year during the *f* (*x*) = *x* + *b* study.

D) The estimated number of marine mammals in
For the linear function *f*, *b* is a constant. the area increased by 1,800 each year during the When *x* = 0, *f* (*x*) = 30. What is the value of *b*? study.
...
D) 30
shaved ice shop. The shop’s inventory starts with 4,500 paper cups, and the manager estimates that 70 of these paper cups are used each day. Based on this estimate, in how many days will the supply of paper cups reach 1,700?
...
*y* > 4*x* + 8 8 The function *h* is defined by *h x*() =. What is 5*x* + 6 For which of the following tables are all the values of *x* and their corresponding values of *y* solutions to the the value of *h*(2) ? given inequality?

A) *x y* 2 19 4 30 6 41
B) *x y* 14 2 8 4 16 6 24
C) *x y* 2 13 4 18 6 23
D) *x y* 2 13 4 21 6 29
...
Which expression is equivalent to 2 2 (*x* + 11) +( *x* − 5)( *x*)+ 5?
...
<u>Number of employees Number of restaurants</u>
...
2 + *bx* + *c* is shown, where *b* The graph of *y* = 2*x*
...
3*x* 5*y* graph of = − + 21 in the *xy*-plane? 7 9
...
|(x + 2)2 + y 2 = 9. Circle B (not shown) is the result|Right triangle ABC is shown. What is the value|
|---|---|
|of shifting circle A down 6 units and increasing the|of tan A ?|
|radius so that the radius of circle B is 2 times the|A) 3|
|radius of circle A. Which equation defines circle B ?|54|
|A) (x + 2)2 + (y + 6)2 = (4)(9)|B) 1|
||3|
|B) 2(x + 2)2 + 2(y + 6)2 = 9||
|C) (x + 2)2 + (y − 6)2 = (4)(9) D) 2(x + 2)2 + 2(y − 6)2 = 9|C) 3 D) 27 3|
...
|25|||
|---|---|---|
|At the time that an article was first featured on the|x|g(x)|
|home page of a news website, there were|−27|33|
|40 comments on the article. An exponential model|−9|00|
|estimates that at the end of each hour after the article|||

2121 55 was first featured on the home page, the number of comments on the article had increased by 190% of

|the number of comments on the article at the end of|The table shows three values of x and their||
|---|---|---|
|the previous hour. Which of the following equations||f ( x)|
|best represents this model, where C is the estimated|corresponding values of g( x)|=|
|number of comments on the article t hours after the||x + 3|
|article was first featured on the home page and t ≤ 4 ?|and f is a linear function. What is the y-intercept of||
|A) C = 40(1.19)t|the graph of y = f ( x)||
|B) C = 40(1.9)t|A) ( 0, 36)||
|C) C = 40(19)t|B) ( 0, 12)||
|D) C = 40(2.9)t|C) ( 0, 4)||
...
In right triangle *ABC*, angle *C* is the right angle and *BC* = 162. Point *D* on side *AB* is connected by a line segment with point *E* on side *AC* such that line segment *DE* is parallel to side *BC* and *CE* = 2*AE*. What is the length of line segment *DE*?
...
), write it as an improper fraction (7/2) or its decimal equivalent (3.5).
...
The function *f* is defined by *f* (*x*) = 8*x*. For what On a street with 7 houses, 2 houses are blue. If a house from this street is selected at random, what is value of *x* does *f* (*x*) = 72 ? the probability of selecting a house that is blue?
...
5 4 3 Which expression is equivalent to 5*x* − 6*x* + 8*x*?
...
The graph of the function *f* is shown, where A) *y* = *f* (*x*). What is the *y*-intercept of the graph?
...
The ratio of the length of line segment *XY* to the 6 length of line segment *ZV* is 6 to 1. If the length of *x* = 8 line segment *XY* is 102 inches, what is the length, in *x* + 3*y* = 26 inches, of line segment *ZV*?

The solution to the given system of equations is A) 17 (*x*, *y*). What is the value of *y*? B) 96
...
The function *f* defined by *f*( )*t* = 14*t* + 9 gives the estimated length, in inches, of a vine plant *t* months after Tavon purchased it. Which of the following is the best interpretation of 9 in this context?
...
C) 5
D) 18
2 Brian saves of the $215 he earns each week from 5
...
4, 10, 18, 4, 4, 5, 6, 5 2 *x* = −841 What is the median of the data set shown? How many distinct real solutions does the given equation have?

A) 4
B) 5 A) Exactly one
C) 7 B) Exactly two
D) 14 C) Infinitely many
D) Zero
16

|A right circular cylinder has a volume of 432 cubic|18|||
|---|---|---|---|
|centimeters. The area of the base of the cylinder is|||1|
|24 square centimeters. What is the height, in|Line k is defined by y = 7x +||. Line j is|
|centimeters, of the cylinder?|||8|
|A) 18|perpendicular to line k in the xy-plane. What is|||
|B) 24 C) 216|the slope of line j ?|||
|D) 10,368|A) −8|||
|||1||
...
Maximum number of*c* 3 If 48 = 47, what is the value of *c*?
...
The table shows the linear relationship between the number of cars, *c*, on a commuter train and the maximum number of passengers and crew, *p*, that 21 the train can carry. Which equation represents the linear relationship between *c* and *p*? (*x* − 2) − 4( *y* + 7) = 117
...
A) 55 (*x* − 2) + 4( *y* + 7) = 442
B) 55 The solution to the given system of equations is
...
In triangle *ABC*, angle *B* is a right angle. The length of side *AB* is 10 37 and the length of side *BC* is *__t* 24 37. What is the length of side *AC*?
...
 *p*  *x* equation can be rewritten as *f* (*x*) =  1 + ,  100 
...
The function *f* is defined by *f* (*x*) = *a x* + *b*, where

*a* and *b* are constants. In the *xy*-plane, the graph of

*y* = *f* (*x*) passes through the point (−24, 0), and
...
48*x* − 64*y* = 48*y* + 24 1 *ry* = − 12*x* 8 In the given system of equations, *r* is a constant. If the system has no solution, what is the value of *r*?

The scatterplot shows the relationship between two variables, *x* and *y*, for data set E. A line of best fit is shown. Data set F is created by multiplying the *y*-coordinate of each data point from data set E by

3.9. Which of the following could be an equation of a line of best fit for data set F?

|y = 46.8 + 5.9|x|
|---|---|
|y = 46.8 + 1.5 y = 12 + 5.9 x y = 12 + 1.5 x|x|
